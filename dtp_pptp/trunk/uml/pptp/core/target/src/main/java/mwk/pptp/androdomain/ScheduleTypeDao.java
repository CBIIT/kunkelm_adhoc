...
public interface ScheduleTypeDao
{
    ...
    /**
     * Transforms the given results to a collection of {@link ScheduleType}
    ...
    /**
     * Gets an instance of ScheduleType from the persistent store.
     * @param id
     * @return ScheduleType
     */
    ...
    /**
     * Loads an instance of ScheduleType from the persistent store.
     * @param id
     * @return ScheduleType
     */
    ...
    /**
     * Loads all entities of type {@link ScheduleType}.
     *
    ...
    /**
     * Creates an instance of ScheduleType and adds it to the persistent store.
     * @param scheduleType
     * @return ScheduleType
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(ScheduleType)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * @return Object
     */
    public Object create(int transform, ScheduleType scheduleType);

    /**
     * Creates a new instance of ScheduleType and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of ScheduleType
     * instances to create.
     *
     * @return the created instances.
     */
    public Collection<ScheduleType> create(Collection<ScheduleType> entities);
     ...
     * @return Collection
     */
    public Collection<?> create(int transform, Collection<ScheduleType> entities);

    /**
     * <p>
     * Creates a new <code>ScheduleType</code>
    ...
    /**
     * Updates the <code>scheduleType</code> instance in the persistent store.
     * @param scheduleType
     */
     ...
     * @param entities
     */
    public void update(Collection<ScheduleType> entities);

    /**
     * Removes the instance of ScheduleType from the persistent store.
     * @param scheduleType
     */
    public void remove(ScheduleType scheduleType);

    /**
     * Removes the instance of ScheduleType having the given
     ...
     * flag is set to one of the constants defined in <code>mwk.pptp.androdomain.ScheduleTypeDao</code>, please note
     * that the {@link #TRANSFORM_NONE} constant denotes no transformation, so the entity itself
     * will be returned.
     *
     * If the integer argument value is unknown {@link #TRANSFORM_NONE} is assumed.
     *
     * @param transform one of the constants declared in {@link mwk.pptp.androdomain.ScheduleTypeDao}
     ...
     * {@link #transformEntity(int,ScheduleType)}
     * method. This method does not instantiate a new collection.
     * <p>
     * This method is to be used internally only.
     *
     * @param transform one of the constants declared in <code>mwk.pptp.androdomain.ScheduleTypeDao</code>
     * @param entities the collection of entities to transform
     * @see #transformEntity(int,ScheduleType)
     */
    public void transformEntities(final int transform, final Collection<?> entities);

    /**
     * Searches for a single instance of ScheduleType.
     * @param displayName the unique displayName to be used in the search.'
     * @return a single instance of ScheduleType.
     */
