 ...
 */
public interface TreatmentRouteTypeDao
{
    /**
    ...
    /**
     * Transforms the given results to a collection of {@link TreatmentRouteType}
    ...
    /**
     * Gets an instance of TreatmentRouteType from the persistent store.
     * @param id
    ...
    /**
     * Loads an instance of TreatmentRouteType from the persistent store.
     * @param id
     * @return TreatmentRouteType
     */
    ...
    /**
     * Loads all entities of type {@link TreatmentRouteType}.
     *
    ...
    /**
     * Creates an instance of TreatmentRouteType and adds it to the persistent store.
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(TreatmentRouteType)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * @return Object
     */
    public Object create(int transform, TreatmentRouteType treatmentRouteType);

    /**
     * Creates a new instance of TreatmentRouteType and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of TreatmentRouteType
     * instances to create.
     *
     * @return the created instances.
     */
    public Collection<TreatmentRouteType> create(Collection<TreatmentRouteType> entities);
     ...
     * @return Collection
     */
    public Collection<?> create(int transform, Collection<TreatmentRouteType> entities);

    /**
     * <p>
     * Creates a new <code>TreatmentRouteType</code>
    ...
    /**
     * Updates the <code>treatmentRouteType</code> instance in the persistent store.
     * @param treatmentRouteType
     */
     ...
     * @param entities
     */
    public void update(Collection<TreatmentRouteType> entities);

    /**
     * Removes the instance of TreatmentRouteType from the persistent store.
     * @param treatmentRouteType
     */
    public void remove(TreatmentRouteType treatmentRouteType);

    /**
     * Removes the instance of TreatmentRouteType having the given
     ...
     * flag is set to one of the constants defined in <code>mwk.pptp.androdomain.TreatmentRouteTypeDao</code>, please note
     * that the {@link #TRANSFORM_NONE} constant denotes no transformation, so the entity itself
     * will be returned.
     *
     * If the integer argument value is unknown {@link #TRANSFORM_NONE} is assumed.
     *
     * @param transform one of the constants declared in {@link mwk.pptp.androdomain.TreatmentRouteTypeDao}
     ...
     * {@link #transformEntity(int,TreatmentRouteType)}
     * method. This method does not instantiate a new collection.
     * <p>
     * This method is to be used internally only.
     *
     * @param transform one of the constants declared in <code>mwk.pptp.androdomain.TreatmentRouteTypeDao</code>
     * @param entities the collection of entities to transform
     * @see #transformEntity(int,TreatmentRouteType)
     */
    public void transformEntities(final int transform, final Collection<?> entities);

    /**
     * Searches for a single instance of TreatmentRouteType.
     * @param displayName the unique displayName to be used in the search.'
     * @return a single instance of TreatmentRouteType.
     */
