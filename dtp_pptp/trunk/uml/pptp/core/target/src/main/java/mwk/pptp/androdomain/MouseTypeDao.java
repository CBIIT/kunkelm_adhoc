...
public interface MouseTypeDao
{
    ...
    /**
     * Transforms the given results to a collection of {@link MouseType}
    ...
    /**
     * Gets an instance of MouseType from the persistent store.
     * @param id
     * @return MouseType
     */
    ...
    /**
     * Loads an instance of MouseType from the persistent store.
     * @param id
     * @return MouseType
     */
    ...
    /**
     * Loads all entities of type {@link MouseType}.
     *
    ...
    /**
     * Creates an instance of MouseType and adds it to the persistent store.
     * @param mouseType
     * @return MouseType
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(MouseType)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * @return Object
     */
    public Object create(int transform, MouseType mouseType);

    /**
     * Creates a new instance of MouseType and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of MouseType
     * instances to create.
     *
     * @return the created instances.
     */
    public Collection<MouseType> create(Collection<MouseType> entities);
     ...
     * @return Collection
     */
    public Collection<?> create(int transform, Collection<MouseType> entities);

    /**
     * <p>
     * Creates a new <code>MouseType</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(String, String, Integer, String)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>mouseType</code> instance in the persistent store.
     * @param mouseType
     */
     ...
     * @param entities
     */
    public void update(Collection<MouseType> entities);

    /**
     * Removes the instance of MouseType from the persistent store.
     * @param mouseType
     */
    public void remove(MouseType mouseType);

    /**
     * Removes the instance of MouseType having the given
     ...
     * flag is set to one of the constants defined in <code>mwk.pptp.androdomain.MouseTypeDao</code>, please note
     * that the {@link #TRANSFORM_NONE} constant denotes no transformation, so the entity itself
     * will be returned.
     *
     * If the integer argument value is unknown {@link #TRANSFORM_NONE} is assumed.
     *
     * @param transform one of the constants declared in {@link mwk.pptp.androdomain.MouseTypeDao}
     ...
     * {@link #transformEntity(int,MouseType)}
     * method. This method does not instantiate a new collection.
     * <p>
     * This method is to be used internally only.
     *
     * @param transform one of the constants declared in <code>mwk.pptp.androdomain.MouseTypeDao</code>
     * @param entities the collection of entities to transform
     * @see #transformEntity(int,MouseType)
     */
    public void transformEntities(final int transform, final Collection<?> entities);

    /**
     * Searches for a single instance of MouseType.
     * @param strain the unique strain to be used in the search.'
     * @return a single instance of MouseType.
     */
    ...
    /**
     * Searches for a single instance of MouseType.
     * @param gender the unique gender to be used in the search.'
     * @return a single instance of MouseType.
     */
    ...
    /**
     * Searches for a single instance of MouseType.
     * @param age the unique age to be used in the search.'
     * @return a single instance of MouseType.
     */
