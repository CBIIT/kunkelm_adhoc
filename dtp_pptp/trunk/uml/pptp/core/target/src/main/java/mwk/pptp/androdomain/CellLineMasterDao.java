 ...
 * @see CellLineMaster
 */
public interface CellLineMasterDao
{
    /**
    ...
    /**
     * Transforms the given results to a collection of {@link CellLineMaster}
    ...
    /**
     * Gets an instance of CellLineMaster from the persistent store.
     * @param id
    ...
    /**
     * Loads an instance of CellLineMaster from the persistent store.
     * @param id
     * @return CellLineMaster
     */
    ...
    /**
     * Loads all entities of type {@link CellLineMaster}.
     *
    ...
    /**
     * Creates an instance of CellLineMaster and adds it to the persistent store.
     * @param cellLineMaster
     * @return CellLineMaster
     */
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(CellLineMaster)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * @return Object
     */
    public Object create(int transform, CellLineMaster cellLineMaster);

    /**
     * Creates a new instance of CellLineMaster and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of CellLineMaster
     * instances to create.
     *
     * @return the created instances.
     */
    public Collection<CellLineMaster> create(Collection<CellLineMaster> entities);
     ...
     * @return Collection
     */
    public Collection<?> create(int transform, Collection<CellLineMaster> entities);

    /**
     * <p>
     * Creates a new <code>CellLineMaster</code>
    ...
    /**
     * Updates the <code>cellLineMaster</code> instance in the persistent store.
     * @param cellLineMaster
     */
     ...
     * @param entities
     */
    public void update(Collection<CellLineMaster> entities);

    /**
     * Removes the instance of CellLineMaster from the persistent store.
     * @param cellLineMaster
     */
    public void remove(CellLineMaster cellLineMaster);

    /**
     * Removes the instance of CellLineMaster having the given
     ...
     * flag is set to one of the constants defined in <code>mwk.pptp.androdomain.CellLineMasterDao</code>, please note
     * that the {@link #TRANSFORM_NONE} constant denotes no transformation, so the entity itself
     * will be returned.
     *
     * If the integer argument value is unknown {@link #TRANSFORM_NONE} is assumed.
     *
     * @param transform one of the constants declared in {@link mwk.pptp.androdomain.CellLineMasterDao}
     ...
     * {@link #transformEntity(int,CellLineMaster)}
     * method. This method does not instantiate a new collection.
     * <p>
     * This method is to be used internally only.
     *
     * @param transform one of the constants declared in <code>mwk.pptp.androdomain.CellLineMasterDao</code>
     * @param entities the collection of entities to transform
     * @see #transformEntity(int,CellLineMaster)
     */
    public void transformEntities(final int transform, final Collection<?> entities);

    /**
     * Searches for a single instance of CellLineMaster.
     * @param pptpIdentifier the unique pptpIdentifier to be used in the search.'
     * @return a single instance of CellLineMaster.
     */
    ...
    /**
     * Searches for a single instance of CellLineMaster.
     * @param strain the unique strain to be used in the search.'
     * @return a single instance of CellLineMaster.
     */
    ...
    /**
     * Searches for a single instance of CellLineMaster.
     * @param implantSite the unique implantSite to be used in the search.'
     * @return a single instance of CellLineMaster.
     */
