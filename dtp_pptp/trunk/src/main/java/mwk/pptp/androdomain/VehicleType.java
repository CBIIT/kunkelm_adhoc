...
public abstract class VehicleType
    implements Serializable, Comparable<VehicleType>
{
    /**
    ...
    /**
     * Returns <code>true</code> if the argument is an VehicleType instance and all identifiers for this entity
    ...
    public boolean equals(Object object)
    {
        ...
        final VehicleType that = (VehicleType)object;
    ...
    /**
     * Constructs new instances of {@link VehicleType}.
     */
    public static final class Factory
    {
        /**
         * Constructs a new instance of {@link VehicleType}.
        ...
        /**
         * Constructs a new instance of {@link VehicleType}, taking all required and/or
         * read-only properties as arguments, except for identifiers.
         * @param displayName String
         * @return newInstance
         */
        public static VehicleType newInstance(String displayName)
        {
            final VehicleType entity = new VehicleTypeImpl();
            entity.setDisplayName(displayName);
            return entity;
        }

        /**
         * Constructs a new instance of {@link VehicleType}, taking all possible properties
         * (except the identifier(s))as arguments.
         * @param displayName String
         * @param cellLineGroups Collection<CellLineGroup>
         * @return newInstance VehicleType
         */
        public static VehicleType newInstance(String displayName, Collection<CellLineGroup> cellLineGroups)
        {
            final VehicleType entity = new VehicleTypeImpl();
            entity.setDisplayName(displayName);
