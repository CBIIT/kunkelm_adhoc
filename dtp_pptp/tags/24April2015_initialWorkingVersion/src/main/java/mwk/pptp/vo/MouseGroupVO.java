 ...
 * MODEL CLASS:  AndroMDAModel::PptpModel::mwk.pptp::vo::MouseGroupVO
...
/**
 * TODO: Model Documentation for class MouseGroupVO
 */
public class MouseGroupVO
    implements Serializable, Comparable<MouseGroupVO>
{
    /** The serial version UID of this class. Needed for serialization. */
    private static final long serialVersionUID = 7923569185568629007L;
     ...
     */
    public MouseGroupVO(final String groupRoleIn)
    {
     ...
     * @param groupRoleIn String
     */
    public MouseGroupVO(final Integer dayIn, final String groupRoleIn)
    {
        this.day = dayIn;
        this.groupRole = groupRoleIn;
    }
    ...
    /**
     * Copies constructor from other MouseGroupVO
     *
     * @param otherBean Cannot be <code>null</code>
     * @throws NullPointerException if the argument is <code>null</code>
     */
    public MouseGroupVO(final MouseGroupVO otherBean)
    {
     ...
     * @param otherBean Cannot be <code>null</code>
     */
    public void copy(final MouseGroupVO otherBean)
    {
        if (null != otherBean)
        {
    ...
    public boolean equals(final Object object)
    {
        ...
        MouseGroupVO rhs = (MouseGroupVO) object;
    ...
    public boolean equalProperties(final Object thatObject)
    {
        ...
        final MouseGroupVO that = (MouseGroupVO)thatObject;
    ...
    // MouseGroupVO value-object java merge-point
}