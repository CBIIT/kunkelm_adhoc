...
public abstract class ImplantSiteType
    implements Serializable, Comparable<ImplantSiteType>
{
    /**
    ...
    /**
     * Returns <code>true</code> if the argument is an ImplantSiteType instance and all identifiers for this entity
    ...
    public boolean equals(Object object)
    {
        ...
        final ImplantSiteType that = (ImplantSiteType)object;
    ...
    /**
     * Constructs new instances of {@link ImplantSiteType}.
     */
    public static final class Factory
    {
        /**
         * Constructs a new instance of {@link ImplantSiteType}.
         * @return new ImplantSiteTypeImpl()
         */
        public static ImplantSiteType newInstance()
        {
            return new ImplantSiteTypeImpl();
        }

        /**
         * Constructs a new instance of {@link ImplantSiteType}, taking all required and/or
         * read-only properties as arguments, except for identifiers.
         * @param displayName String
         * @return newInstance
         */
        public static ImplantSiteType newInstance(String displayName)
        {
            final ImplantSiteType entity = new ImplantSiteTypeImpl();
            entity.setDisplayName(displayName);
            return entity;
        }

        /**
         * Constructs a new instance of {@link ImplantSiteType}, taking all possible properties
         * (except the identifier(s))as arguments.
         * @param displayName String
         * @param cellLineGroups Collection<CellLineGroup>
         * @return newInstance ImplantSiteType
         */
        public static ImplantSiteType newInstance(String displayName, Collection<CellLineGroup> cellLineGroups)
        {
            final ImplantSiteType entity = new ImplantSiteTypeImpl();
            entity.setDisplayName(displayName);
     ...
     */
    public int compareTo(ImplantSiteType o)
    {
        int cmp = 0;
        if (this.getId() != null)
        {
