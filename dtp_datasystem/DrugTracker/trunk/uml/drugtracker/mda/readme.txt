    ...
    The project located in this directory has been generated by Mark W. Kunkel
    ...
    that a model called 'drugtracker' has been created within your Magic Draw model.

    Important: before launching AndroMDA, be sure to have exported your model.

    /drugtracker J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/Mark W. Kunkel/.m2/repository/drugtracker/
