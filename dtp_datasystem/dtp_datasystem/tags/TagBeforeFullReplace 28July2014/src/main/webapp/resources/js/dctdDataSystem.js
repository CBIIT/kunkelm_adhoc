...
function showMolFile() {
    ...
    document.getElementById('datasystemForm:molfile').value = molFile;
}

function showSmilesChiral() {
    var jcped = document.JChemPaintEditor;
    var smiles = jcped.getSmilesChiral();
    document.getElementById('datasystemForm:chiralsmilesstring').value = smiles;
}

function showSmiles() {
    var jcped = document.JChemPaintEditor;
    var smiles = jcped.getSmiles();
    document.getElementById('datasystemForm:smilesstring').value = smiles;
}
...
function loadFromSmiles() {
    ...
    var smiles = document.getElementById('datasystemForm:smilesforload').value;
    jcped.clear();
    if (smiles) {
