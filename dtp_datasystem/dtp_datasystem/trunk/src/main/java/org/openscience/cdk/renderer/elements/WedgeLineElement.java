...
/**
 * An element representing a dashed, solid or crisscross wedge. Note that
 * according to IUPAC recommendations {
 *
 * @cdk.cite IUPAC2006} the criss cross wedge is discouraged. We still need to
 * show it, since e. g. MDL mol file definition has it.
 *
...
public class WedgeLineElement extends LineElement {
     ...
     * @param color The desired color.
     */
    public WedgeLineElement(LineElement element, int type, Direction direction, Color color) {
