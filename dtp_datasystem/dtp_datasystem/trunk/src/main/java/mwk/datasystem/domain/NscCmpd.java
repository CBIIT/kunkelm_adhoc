    ...
    extends CmpdImpl
{
     ...
     */
    private static final long serialVersionUID = 7410872944067168021L;
    ...
    private String pseudoAtoms;

    /**
     * 
     * @return this.pseudoAtoms String
     */
    public String getPseudoAtoms()
    {
        return this.pseudoAtoms;
    }

    /**
     * 
     * @param pseudoAtomsIn String
     */
    public void setPseudoAtoms(String pseudoAtomsIn)
    {
        this.pseudoAtoms = pseudoAtomsIn;
    }
    ...
    private String saltSmiles;

    /**
     * 
     * @return this.saltSmiles String
     */
     ...
     */
    public void setSaltSmiles(String saltSmilesIn)
    {
     ...
     * @param saltIdIn Long
     */
    public void setSaltId(Long saltIdIn)
    {
    ...
    private CmpdInventory cmpdInventory;

    /**
     * 
     * @return this.cmpdInventory CmpdInventory
     */
    public CmpdInventory getCmpdInventory()
    {
        return this.cmpdInventory;
    }

    /**
     * 
     * @param cmpdInventoryIn CmpdInventory
     */
    public void setCmpdInventory(CmpdInventory cmpdInventoryIn)
    {
        this.cmpdInventory = cmpdInventoryIn;
    }
    ...
    public static final class Factory
    {
         ...
         * @param distribution String
         * @param cas String
         * @param pseudoAtoms String
         * @param saltName String
         * @param saltSmiles String
         * @param saltId Long
         ...
         * @param cmpdInventory CmpdInventory
        ...
        public static NscCmpd newInstance(Collection<CmpdListMember> cmpdListMembers, String name, Long nscCmpdId, String prefix, Integer nsc, String conf, String distribution, String cas, String pseudoAtoms, String saltName, String saltSmiles, Long saltId, Collection<CmpdProject> cmpdProjects, CmpdFragment cmpdParentFragment, Collection<CmpdAlias> cmpdAliases, CmpdBioAssay cmpdBioAssay, Collection<CmpdPubChemSid> cmpdPubChemSids, Collection<CmpdFragment> cmpdFragments, Collection<CmpdRelated> cmpdRelateds, CmpdInventory cmpdInventory, Collection<CmpdTarget> cmpdTargets, Collection<CmpdPlate> cmpdPlates, Collection<CmpdSet> cmpdSets)
        {
            ...
            entity.setDistribution(distribution);
            entity.setCas(cas);
            entity.setPseudoAtoms(pseudoAtoms);
            entity.setSaltName(saltName);
            entity.setSaltSmiles(saltSmiles);
            entity.setSaltId(saltId);
            ...
            entity.setCmpdInventory(cmpdInventory);
    ...
    public int compareTo(NscCmpd o)
    {
        ...
        else
        {
            ...
            if (this.getPseudoAtoms() != null)
            {
                cmp = (cmp != 0 ? cmp : this.getPseudoAtoms().compareTo(o.getPseudoAtoms()));
            }
            if (this.getSaltName() != null)
            {
                cmp = (cmp != 0 ? cmp : this.getSaltName().compareTo(o.getSaltName()));
            }
            if (this.getSaltSmiles() != null)
            {
                cmp = (cmp != 0 ? cmp : this.getSaltSmiles().compareTo(o.getSaltSmiles()));
            }
            if (this.getSaltId() != null)
            {
                cmp = (cmp != 0 ? cmp : this.getSaltId().compareTo(o.getSaltId()));
            }
        }
        return cmp;
    }
