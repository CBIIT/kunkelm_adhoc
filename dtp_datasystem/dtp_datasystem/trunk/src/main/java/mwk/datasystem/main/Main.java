...
//    public static void testAmbitTautomers() {
//
//        try {
//
...
//
//            ambit2.tautomers.TautomerManager tm = new TautomerManager();
//            IAtomContainer NSC3124 = sp.parseSmiles("Oc1ccc(cc1)N=O");
//            tm.setStructure(NSC3124);
//                        
//            Vector<IAtomContainer> vec = tm.generateTautomers();
//
//            for (IAtomContainer taut : vec) {
//                System.out.println(sg.create(taut));
//            }
//
//        } catch (Exception e) {
//            e.printStackTrace();
...
//    }
    ...
    public static void testCdk() {
        ...
        try {
            ...
            IMolecule NSC3124 = sp.parseSmiles("O=Nc1ccc(O)cc1");
            IMolecule NSC36938 = sp.parseSmiles("ON=C1C=CC(=O)C=C1");
...
// configure atom types
    ...
    public static void tautomerTestIhnfeldSMARTS() {
        ...
        try {
            ...
            IMolecule target = sp.parseSmiles("ON=C1C=CC(=O)C=C1");
