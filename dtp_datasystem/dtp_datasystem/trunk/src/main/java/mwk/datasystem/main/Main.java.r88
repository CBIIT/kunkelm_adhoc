...
//        idsForDelete.add(17336l);
//        idsForDelete.add(17337l);
//
//        ArrayList<CmpdListMemberVO> lmForDelete = new ArrayList<CmpdListMemberVO>();
//
//        for (Long l : idsForDelete) {
//            CmpdListMemberVO clmVO = new CmpdListMemberVO();
//            clmVO.setId(l);
//            lmForDelete.add(clmVO);
//        }
//
