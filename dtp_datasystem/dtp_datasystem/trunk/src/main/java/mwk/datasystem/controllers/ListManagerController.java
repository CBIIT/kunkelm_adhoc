...
public class ListManagerController implements Serializable {
    ...
    public String performUpdateAvailableLists() {
        ...
        try {
            ...
            // don't overwrite known lists since they may already have data fetched

//            // this is quick and dirty for now instead of overwriting equals in the class
//
//            HashSet<Long> idSet = new HashSet<Long>();
//
//            for (CmpdListVO clVO : justFetchedLists) {
//                if (!idSet.contains(clVO.getCmpdListId())) {
