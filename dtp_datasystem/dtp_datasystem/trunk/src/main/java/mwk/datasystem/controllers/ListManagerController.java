...
public class ListManagerController implements Serializable {
    ...
    // for biodata
    private List<String> parametersBiodata;
    // for voting whether counterion
    private String parameterCounterion;
    //
...
// used when saving listLogic results
    ...
    public String performMakeListPublic() {
        ...
        if (this.selectedList.getListOwner().equals(this.getLoggedUser())) {
    ...
    public void handleDeleteList(ActionEvent actionEvent) {
        ...
        if (this.listForDelete.getListOwner().equals(this.getLoggedUser())) {
            HelperCmpdList helper = new HelperCmpdList();
    ...
    public String performUpdateAvailableLists() {
        ...
        HelperCmpdList helper = new HelperCmpdList();
        List<CmpdListVO> lists = helper.showAvailableCmpdLists(this.getLoggedUser());
    ...
    public String performCreateListBySearch() {
        ...
        CmpdListVO tempCLvo = cmpdHelper.createCmpdListByNscs(this.listName, nscIntList, this.getLoggedUser());
    ...
    public void handleFileUpload(FileUploadEvent event) {
        ...
        try {
            ...
            String listOwner = this.getLoggedUser();
            String shareWith = this.getLoggedUser();
    ...
    public List<String> getParametersBiodata() {
        return parametersBiodata;
    }

    public void setParametersBiodata(List<String> parametersBiodata) {
        this.parametersBiodata = parametersBiodata;
    }

    public String getParameterCounterion() {
        return parameterCounterion;
    }

    public void setParameterCounterion(String parameterCounterion) {
        this.parameterCounterion = parameterCounterion;
    }
