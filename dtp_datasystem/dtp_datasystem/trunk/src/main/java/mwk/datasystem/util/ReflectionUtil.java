 ...
 * when dealing with generic object types.</p>
 *
...
public class ReflectionUtil {
     ...
     * object.
     *
     * @param type the {@code Type} object whose its representing {@code Class}
     * object will be instantiated.
     * @return a newly allocated instance of the class represented by the
     * invoked {@code Type} object.
     *
     * @throws ClassNotFoundException if the class represented by this
     * {@code Type} object cannot be located.
     * @throws InstantiationException if this {@code Type} represents an
    ...
    /**
     * Checks whether a {@code Constructor} object with no parameter types is
     * specified by the invoked {@code Class} object or not.
     *
     * @param clazz the {@code Class} object whose constructors are checked.
     * @return {@code true} if a {@code Constructor} object with no parameter
     * types is specified.
    ...
    /**
     * Returns a {@code Class} object that identifies the declared class for the
     * field represented by the given {@code String name} parameter inside the
     * invoked {@code Class<?> clazz} parameter.
     *
     * @param clazz the {@code Class} object whose declared fields to be checked
     * for a certain field.
     * @param name the field name as {@code String} to be compared with
     * {@link Field#getName()}
     ...
     * @param name the method name as {@code String} to be compared with
     * {@link Method#getName()}
    ...
    /**
     * Extracts the enum constant of the specified enum class with the specified
     * name. The name must match exactly an identifier used to declare an enum
     * constant in the given class.
     *
     * @param clazz the {@code Class} object of the enum type from which to
     * return a constant.
     ...
     * constant with the specified name, or the specified class object does not
