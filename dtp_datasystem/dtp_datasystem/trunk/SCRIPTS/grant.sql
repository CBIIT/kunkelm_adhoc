grant select, insert, update on ad_hoc_cmpd to datasystem_user;                    
grant select, insert, update on ad_hoc_cmpd_fragment to datasystem_user;           
grant select, insert, update on ad_hoc_cmpd_fragment_p_chem to datasystem_user;    
grant select, insert, update on ad_hoc_cmpd_fragment_structure to datasystem_user; 
...
grant select, insert, update on cmpd_list to datasystem_user;                      
grant select, insert, update on cmpd_list_member to datasystem_user;               
