...
-- These SHOULD only set to allow modifications while doing build or quality control
...
grant select, insert, update, delete on cmpd_legacy_cmpd to datasystem_user;   
-- These SHOULD only set to allow modifications while doing build or quality control
