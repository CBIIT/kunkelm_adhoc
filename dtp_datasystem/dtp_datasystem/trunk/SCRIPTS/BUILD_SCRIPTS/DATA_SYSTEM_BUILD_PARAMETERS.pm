...
push @datasystemTableList, "cmpd_fragment_type";
...
push(@qualityControlCriteriaList,"abs(prod_mw - fw) = 0,round(mw) = round(fw)");
push(@qualityControlCriteriaList,"abs(prod_mw - fw) < 1,abs( mw - fw ) <1");
push(@qualityControlCriteriaList,"abs(prod_mw - fw) < 2,abs( mw - fw ) <2");
push(@qualityControlCriteriaList,"abs(prod_mw - fw) < 3,abs( mw - fw ) <3");
push(@qualityControlCriteriaList,"abs(prod_mw - fw) < 4,abs( mw - fw ) <4");
push(@qualityControlCriteriaList,"abs(prod_mw - fw) < 5,abs( mw - fw ) <5");
push(@qualityControlCriteriaList,"abs(prod_mw - fw) > 5,abs( mw - fw ) >5");
...
push(@qualityControlCriteriaList,"r groups, molecular_formula like '%R#%'");
