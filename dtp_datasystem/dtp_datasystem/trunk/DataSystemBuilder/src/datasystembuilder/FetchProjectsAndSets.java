...
public class FetchProjectsAndSets {
    ...
    public static void fetchProjects(Connection postgresConn, Connection oracleConn) throws Exception {
        ...
        try {
            ...
            sqlString = "select cp.nsc, cp.projectcode, lu.description from OPS$ORADIS.chem_project cp, OPS$ORADIS.lookup_project lu where cp.projectcode = lu.projectcode";
            ...
            while (rs.next()) {
                ...
                String projectType = rs.getString("description");
