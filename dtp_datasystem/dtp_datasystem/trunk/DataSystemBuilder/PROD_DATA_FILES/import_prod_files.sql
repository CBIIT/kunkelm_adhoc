...
\copy prod_cmpd from /media/KINGSTON/prod_cmpd.csv csv header
\copy prod_strc from /media/KINGSTON/prod_strc.csv csv header
...
create table prod_projects (nsc int, project_code varchar(1024), description varchar(1024));
create table prod_plated_sets (nsc int, plate_set varchar(1024));

\copy prod_inventory from /media/KINGSTON/prod_inventory.csv csv header
\copy prod_chem_name from /media/KINGSTON/prod_chem_name.csv csv header
\copy prod_projects from /media/KINGSTON/prod_projects.csv csv header
\copy prod_plated_sets from /media/KINGSTON/prod_plated_sets.csv csv header
...
\copy prod_count_nci60 from /media/KINGSTON/prod_count_nci60.csv csv header
\copy prod_count_hf from /media/KINGSTON/prod_count_hf.csv csv header
\copy prod_count_xeno from /media/KINGSTON/prod_count_xeno.csv csv header
