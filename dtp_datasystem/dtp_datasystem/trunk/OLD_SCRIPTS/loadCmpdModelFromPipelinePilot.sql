...
insert into temp select distinct nsc, 'two_strc_no_lbl_one_salt' from two_strc_no_lbl_one_salt; -- limit 50;
...
(
    ...
    union
    select nsc, fragmentindex from two_strc_no_lbl_one_salt where salt_smiles is null and can_smi != '[RH]'
    union
