...
-------------------------------------
-------------------------------------
-- bioassay data isn't propagating!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
-------------------------------------
-------------------------------------
-------------------------------------
-------------------------------------
...
insert into cmpd_inventory(id, inventory, nsc_cmpd_fk)
select nsc, inventory, nsc 
from prod_inventory 
where nsc in (select nsc from parent_with_salt);
...
create table temp
as
select project_code, project_type, count(*) as count_nsc
from prod_projects
group by 1,2;
...
select nextval('cmpd_project_seq'), project_code, project_type
from temp;
