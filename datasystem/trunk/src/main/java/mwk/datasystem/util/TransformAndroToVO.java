...
import mwk.datasystem.androdomain.CmpdAlias;
import mwk.datasystem.androdomain.CmpdBioAssay;
import mwk.datasystem.androdomain.CmpdFragment;
import mwk.datasystem.androdomain.CmpdFragmentPChem;
import mwk.datasystem.androdomain.CmpdFragmentStructure;
import mwk.datasystem.androdomain.CmpdTarget;
...
//  }
    ...
    public static CmpdVO toCmpdVO(Cmpd incomingCmpd) {
        ...
        if (entityIn instanceof NscCmpdImpl) {
            ...
            //MWK INVENTORIES is busted
            //cmpdVO.setInventory(entityIn.getCmpdInventories());
